...
router
  .get("/register", [middlewares.user.registerAccount])
  .get("/home", [middlewares.response.render("user/beranda.ejs")])
  .get("/employee-data", [
